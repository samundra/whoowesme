...
const DashboardPageLayout: React.FunctionComponent<CommonLayoutProps> = ({ children }) => {
  ...
  return (
    <DashboardLayout>
      <Sider collapsible collapsed={siderState.collapsed} onCollapse={siderState.toggleSider} width={220}>
        {!siderState.collapsed && (
          <SidebarMenuLogo src="/img/sidebarmenu-logo-192x45.jpg" alt="expanded application logo" />
        )}
        {siderState.collapsed && (
          <SidebarMenuLogo src="/img/sidebarmenu-logo-74x45.jpg" alt="collapsed application logo" />
        )}
        <AppMenu />
      </Sider>
      <Layout>
